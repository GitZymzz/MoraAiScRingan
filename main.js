	...
	sock.ev.on("connection.update", async (update) => {
		...
		if (connection === "close") {
			...
			if (reason === DisconnectReason.badSession) {
				...
				console.log("🔌 Yahh, koneksinya putus... Sabar ya, xyzhiraa coba sambungin lagi! 🔄");
				startHaruka();
			} else if (reason === DisconnectReason.connectionLost) {
				console.log("📡 Oops, koneksi ke server hilang, kak! Tunggu bentar, xyzhiraa sambungin lagi ya~ 🚀");
				startHaruka();
				...
				console.log("🔄 Sebentar ya, xzyhiraa lagi mulai ulang koneksinya biar lancar lagi! ♻️");
				startHaruka();
			} else if (reason === DisconnectReason.timedOut) {
				console.log("⏳ Hmm, koneksinya timeout nih, kak! xzyhiraa coba sambungin ulang ya~ 🌐");
				startHaruka();
			} else {
				console.log(`❓ Eh, alasan disconnect-nya gak jelas nih, kak... (${reason} | ${connection}) 🤔 Tapi tenang, xzyhiraa coba sambungin lagi ya! 💪`);
				startHaruka();
			}
